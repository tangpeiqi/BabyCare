...
Requirement
Hardware: Rayban Meta Glasses, iPhone, laptop/desktop
...
You will need to have your Gemini API key ready. Go to Google AI Studio to generate your API key. Then go to Xcode>TARGETS>info list, paste the key to the Gemini_API_key row.
